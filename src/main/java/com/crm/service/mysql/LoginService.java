...
public class LoginService {
    ...
    public Page selectUserByUserNameAndPassword(String username, String password) {
        ...
        Map map = new HashMap();
        List<String> permissions = usersMapper.queryPermissionByUserId(user.getId());
        List<Integer> rolesID = rolesMapper.queryRolesByUserID(user.getId());
        List<Integer> moduleID = modulesMapper.queryModuleIDByrolesID(rolesID);
